...
<img src="/images/blog/hangout/widget_ss.jpg" alt="Widget Screenshot" width="50%"/>
...
What ended up being nice was that now I know when I forget to log a hangout.
...
A first natural idea was to display a sort of heatmap of people I see, 
as a sort of calendar.
I wanted to provide some sort of individuality to the data, so my first attempt
...
I had older days towards the center of the widget, sort of as a tunnel through time.
...
This had another great side effect, I could now use that random list of names
