...
<style>
  ...
  .nav-item.separate .open { opacity: 1; transform: scale(.47); z-index: 0; }
  ...
  .nav-item:hover.separate .open, .nav-item:focus-visible.separate .open { transform: translateX(2.1rem) scale(.47) rotate(7deg); }
